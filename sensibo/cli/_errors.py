...
Every failure inside sensibo-cli raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`sensibo.cli._output`,
...
# Exit-code policy. Documented in ``sensibo-cli learn`` output.
# 0      = success
