...
type: command
description: >
  sensibo-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in sensibo-cli, handling
